...
def _evaluate_order_groups_once(order_groups, yy, time_limit=None, mipgap=None, run_conflict_refiner=True):
...
def evaluate_order_groups(order_groups, yy, max_retries=3, time_limit=None, mipgap=None):
    """
...
def variable_neighborhood_search(Sum_demand, orders, group_capacity, max_iterations,
    ...
    while iteration < k_max:
        ...
        while k <= n_neighborhoods:
            ...
            candidate_cost = evaluate_order_groups(candidate_groups, candidate_yy)

            if candidate_cost < current_cost:
                # Improvement: accept as the new current solution and
                # restart the neighborhood search from k=1.
